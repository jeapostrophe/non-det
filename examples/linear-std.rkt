...
(module+ test
  (define A (const 'A))
  (define B (const 'B))
  (nrun #:mode 'dfs (proves-top (list A) A))
  (nrun (proves-top (list A B) (tensor A B)))
  (nrun (proves-top (list A B) (tensor B A)))
  (nrun (proves-top (list (tensor A B)) (tensor B A)))
  (nrun (proves-top (list A A) (tensor A A)))
  (nrun (proves-top (list A A A) (tensor A (tensor A A)))))
